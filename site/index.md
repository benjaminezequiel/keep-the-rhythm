...
- [Code Blocks]({{ '/code-blocks/' | relative_url }})
- [Settings & Data]({{ '/settings/' | relative_url }})
- [FAQ & Support]({{ '/faq/' | relative_url }})

Source on [GitHub](https://github.com/benjaminezequiel/keep-the-rhythm).
