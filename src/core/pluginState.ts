...
export class PluginState {
	...
	private _vaultReadTimeout: typeof setTimeout | null = null;
	public DEBOUNCE_VAULT_READ: number = 1000;

	private _currentVaultCount: number | null = null;
	get currentVaultCount(): number {
		return this._currentVaultCount ?? 0;
	}
	...
	public _currentFileActivity: DailyActivity | null = null;
