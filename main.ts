...
import "./styles.css";
import { getCurrentDate, parseToggles, formatDate } from "@/utils";
import { parseQuery } from "./src/queries";
...
export default class WordCountPlugin extends Plugin {
	...
	// 		const pathConditions = parseQuery(query);
	...
	// 							condition.target,
	// 						);
	// 						if (pathIncluded && condition.inclusion) {
	// 							includeFile.push(true);
	// 						} else if (!pathIncluded && !condition.inclusion) {
	// 							includeFile.push(true);
	// 						} else if (pathIncluded && !condition.inclusion) {
	...
	// 						}
	// 					}
	// 					return includeFile.some((condition) => {
	// 						condition == true;
	// 					});
	// 				},
	// 			);
